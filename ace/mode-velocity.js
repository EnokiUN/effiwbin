      ...
      },
      {
        token: function (value) {
          if (keywords.hasOwnProperty(value)) return "keyword";
            ...
            builtinFunctions.hasOwnProperty(value) ||
            builtinFunctions.hasOwnProperty(value.substring(1))
          )
...
define("ace/mode/folding/velocity", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
...
*/
  ...
  var VelocityHighlightRules =
    require("./velocity_highlight_rules").VelocityHighlightRules;
