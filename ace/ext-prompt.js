define("ace/ext/menu_tools/get_editor_keyboard_shortcuts", [
  "require",
  "exports",
  "module",
  "ace/lib/keys",
...
define("ace/autocomplete/popup", [
  ...
  var AcePopup = function (parentNode) {
    ...
    popup.renderer.container.setAttribute(
      "aria-label",
    ...
    bgTokenizer.$tokenizeRow = function (row) {
      ...
      if (data.meta) tokens.push({ type: "completion-meta", value: data.meta });
      if (data.message)
...
define("ace/autocomplete/util", ["require", "exports", "module"], function (
  require,
  exports,
  module
) {
...
define("ace/ext/menu_tools/settings_menu.css", [
  "require",
  "exports",
  "module",
], function (require, exports, module) {
...
define("ace/ext/menu_tools/overlay_page", [
  ...
  module.exports.overlayPage = function overlayPage(
    editor,
    contentElement,
    callback
  ) {
...
define("ace/ext/prompt", [
  ...
  function prompt(editor, message, options, callback) {
    ...
    var el = dom.buildDom([
      "div",
      {
        class:
          ...
          (options.hasDescription ? " input-box-with-description" : ""),
      },
    ]);
    ...
    if (options.hasDescription) {
      var promptTextContainer = dom.buildDom([
        "div",
  ...
  prompt.commands = function (editor, callback) {
    ...
    function getEditorCommandsByName(excludeCommands) {
      ...
      editor.keyBinding.$handlers.forEach(function (handler) {
        ...
        for (var i in cbn) {
          ...
          var commands = cbn[i];
          var description =
            commands.description || normalizeName(commands.name);
          if (!Array.isArray(commands)) commands = [commands];
          commands.forEach(function (command) {
            if (typeof command != "string") command = command.name;
    ...
    prompt(editor, "", {
      ...
      getCompletions: function (cmdLine) {
        ...
        var recentlyUsedCommands = getFilteredCompletions(
          this.history(),
          prefix
        );
        var otherCommands = getUniqueCommandList(
          shortcutsArray,
