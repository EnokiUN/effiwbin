...
define("ace/mode/apex_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var TextHighlightRules =
    require("../mode/text_highlight_rules").TextHighlightRules;
  var DocCommentHighlightRules =
    require("../mode/doc_comment_highlight_rules").DocCommentHighlightRules;
  var ApexHighlightRules = function () {
    var mainKeywordMapper = this.createKeywordMapper(
      {
        "variable.language":
          "activate|any|autonomous|begin|bigdecimal|byte|cast|char|collect|const" +
    ...
    this.$rules = {
      ...
      soql: [
        {
          regex:
            "(:?ASC|BY|CATEGORY|CUBE|DATA|DESC|END|FIND|FIRST|FOR|FROM|GROUP|HAVING|IN|LAST" +
      ...
      "log-header": [
        ...
        },
        {
          token: "keyword",
          regex:
            "(?:EXECUTION_FINISHED|EXECUTION_STARTED|CODE_UNIT_STARTED" +
