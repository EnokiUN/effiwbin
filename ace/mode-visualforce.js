...
define("ace/mode/visualforce_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var HtmlHighlightRules =
    require("../mode/html_highlight_rules").HtmlHighlightRules;
...
define("ace/mode/visualforce", [
  ...
  var VisualforceHighlightRules =
    require("./visualforce_highlight_rules").VisualforceHighlightRules;
  var XmlBehaviour = require("./behaviour/xml").XmlBehaviour;
  var HtmlFoldMode = require("./folding/html").FoldMode;
