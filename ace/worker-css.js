  ...
  var CSSLint = (function () {
            ...
            function (require, module, exports) {
              ...
              Matcher.parse = function (str) {
                ...
                andand = function () {
                  ...
                  return m.length === 1
                    ? m[0]
                    : Matcher.andand.apply(Matcher, m);
                };
                seq = function () {
                  var m = [mod()];
                  while (reader.readMatch(/^ (?![&|\]])/) !== null) {
              ...
              Matcher.fromType = function (type) {
                ...
                return new Matcher(function (expression) {
                  return (
                    expression.hasNext() &&
                    ValidationTypes.isType(expression, type)
                  );
                }, type);
              };
                ...
                var ms = Array.prototype.slice
                  ...
                  .reduce(function (acc, v) {
                    if (v.expand) {
                      ...
                      acc.push.apply(
                        acc,
                        ValidationTypes.complex[v.expand].options
                      );
                    } else {
              ...
              Parser.prototype = (function () {
                var proto = new EventTarget(), // new prototype
                  ...
                  additions = {
                    ...
                    _supports_declaration_condition: function (
                      requireStartParen
                    ) {
                      var tokenStream = this._tokenStream;
                    ...
                    _media: function () {
                      ...
                      while (true) {
                        if (tokenStream.peek() === Tokens.PAGE_SYM) {
                          ...
                          tokenStream.peek() === Tokens.FONT_FACE_SYM
                        ) {
                          this._font_face();
                    ...
                    _media_query: function () {
                      ...
                      if (type === null && expressions.length === 0) {
                        ...
                        while (tokenStream.match(Tokens.IDENT)) {
                          if (
                            tokenStream.token().value.toLowerCase() !== "and"
                          ) {
                            this._unexpectedToken(tokenStream.token());
                          }
                    ...
                    _term: function (inFunction) {
                      ...
                      if (
                        tokenStream.peek() === Tokens.IE_FUNCTION &&
                        ...
                        if (unary === null) {
                          line = tokenStream.token().startLine;
                          col = tokenStream.token().startCol;
                          part = PropertyValuePart.fromToken(
                            tokenStream.token()
                          );
                        }
                        this._readWhitespace();
                        ...
                        if (token === null) {
                          ...
                          if (value === null) {
                            if (
                              tokenStream.LA(3) === Tokens.EQUALS &&
                              this.options.ieFilters
                            ) {
                              value = this._ie_function();
                            } else {
                      ...
                      return part !== null
                        ? part
                        : value !== null
                        ? new PropertyValuePart(
                            unary !== null ? unary + value : value,
                            line,
                            col
                          )
                        : null;
                    ...
                    _ie_function: function () {
                      var tokenStream = this._tokenStream,
                        ...
                        lt;
                      if (
                        tokenStream.match([Tokens.IE_FUNCTION, Tokens.FUNCTION])
                      ) {
                        functionText = tokenStream.token().value;
                    ...
                    _readDeclarations: function (checkStart, readMargins) {
                      ...
                      try {
                        while (true) {
                          if (
                            tokenStream.match(Tokens.SEMICOLON) ||
          ...
          7: [
            function (require, module, exports) {
              ...
              var Properties = (module.exports = {
                ...
                volume: 1,
                "white-space":
                  "normal | pre | nowrap | pre-wrap | pre-line | -pre-wrap | -o-pre-wrap | -moz-pre-wrap | -hp-pre-wrap", // https    ://perishablepress.com/wrapping-content/
          ...
          11: [
            function (require, module, exports) {
              ...
              PropertyValuePart.fromToken = function (token) {
                var part = new PropertyValuePart(
                  token.value,
                  token.startLine,
                  token.startCol,
                  {
          ...
          12: [
            function (require, module, exports) {
              ...
              Pseudos.isElement = function (pseudo) {
                return (
                  pseudo.indexOf("::") === 0 ||
                  Pseudos[pseudo.toLowerCase()] === Pseudos.ELEMENT
                );
              };
            },
            {},
          ...
          17: [
            function (require, module, exports) {
              ...
              function wouldStartIdent(twoCodePoints) {
                return (
                  typeof twoCodePoints === "string" &&
                  ((twoCodePoints[0] === "-" &&
                    isNameStart(twoCodePoints[1])) ||
                    isNameStart(twoCodePoints[0]))
                );
              }
              ...
              function wouldStartUnsignedNumber(twoCodePoints) {
                return (
                  typeof twoCodePoints === "string" &&
                  (isDigit(twoCodePoints[0]) ||
                    (twoCodePoints[0] === "." && isDigit(twoCodePoints[1])))
                );
              }
              ...
              TokenStream.prototype = mix(new TokenStreamBase(), {
                  ...
                  while (c) {
                    switch (c) {
                      ...
                      case ":":
                        ...
                        break;
                      case "<":
                        token = this.htmlCommentStartToken(
                          c,
                          startLine,
                          startCol
                        );
                ...
                readURI: function (first) {
                  ...
                  if (inner === null || c !== ")") {
                    ...
                    uri +=
                      PropertyValuePart.serializeString(inner) + reader.read();
                  }
                ...
                singleProperty: function (types, expression) {
                  ...
                  if (!result) {
                    if (expression.hasNext() && !expression.isFirst()) {
                      ...
                      throw new ValidationError(
                        "Expected (" +
                          ValidationTypes.describe(types) +
                          ") but found '" +
                          value +
                          "'.",
                        value.line,
            ...
            function (require, module, exports) {
              ...
              copy(ValidationTypes, {
                ...
                isAny: function (expression, types) {
                  ...
                  for (
                    i = 0, len = args.length;
                    i < len && !found && expression.hasNext();
                    i++
                  ) {
                ...
                simple: {
                  ...
                  "<color>": function (part) {
                    return (
                      part.type === "color" ||
                      String(part) === "transparent" ||
                      String(part) === "currentColor"
                    );
                  },
                  ...
                  "<feature-tag-value>": function (part) {
                    return (
                      part.type === "function" && /^[A-Z0-9]{4}$/i.test(part)
                    );
                  },
                  "<filter-function>":
                  ...
                  "<ident-not-generic-family>": function (part) {
                    return (
                      this["<ident>"](part) && !this["<generic-family>"](part)
                    );
                  },
                ...
                complex: {
                  ...
                  "<border-image-slice>": Matcher.many(
                    [true /* first element is required */],
    ...
    var CSSLint = (function () {
      ...
      api.verify = function (text, ruleset) {
        ...
        try {
          ...
          reporter.error(
            "Fatal error, cannot continue: " + ex.message,
            ex.line,
            ex.col,
            {}
          );
    ...
    Reporter.prototype = {
      ...
      report: function (message, line, col, rule) {
        "use strict";
        if (
          this.allow.hasOwnProperty(line) &&
            ...
            for (prop in compatiblePrefixes) {
              if (compatiblePrefixes.hasOwnProperty(prop)) {
                ...
                if (CSSLint.Util.indexOf(variations, name.text) > -1) {
                  ...
                  if (
                    CSSLint.Util.indexOf(
                      propertyGroups[prop].actual,
                      name.text
                    ) === -1
                  ) {
                ...
                for (i = 0, len = full.length; i < len; i++) {
                  ...
                  if (CSSLint.Util.indexOf(actual, item) === -1) {
                    ...
                    reporter.report(
                      ...
                      value.actualNodes[0].line,
                      value.actualNodes[0].col,
                      rule
                    );
                  }
                }
    ...
    CSSLint.addRule({
      ...
      init: function (parser, reporter) {
        ...
        function reportProperty(name, display, msg) {
          if (properties[name]) {
            if (
              typeof propertiesToCheck[name] !== "string" ||
                ...
                if (typeof stack[value.parts[i].uri] === "undefined") {
                  ...
                  reporter.report(
                    "Background image '" +
                      ...
                      stack[value.parts[i].uri].line +
                      ", col " +
                      stack[value.parts[i].uri].col +
                      ".",
                    event.line,
                    event.col,
                    rule
      ...
      init: function (parser, reporter) {
        ...
        parser.addListener("property", function (event) {
          ...
          if (
            ...
            reporter.report(
              "Duplicate property '" + event.property + "' found.",
              event.line,
              event.col,
              rule
            );
    ...
    CSSLint.addRule({
      ...
      init: function (parser, reporter) {
        ...
        parser.addListener("endstylesheet", function () {
          if (count > 5) {
            reporter.rollupWarn(
              "Too many @font-face declarations (" + count + ").",
              rule
            );
          }
        });
          ...
          if (missing.length && missing.length < 4) {
            reporter.report(
              "Missing vendor-prefixed CSS gradients for " +
                missing.join(", ") +
                ".",
              event.selectors[0].line,
              event.selectors[0].col,
              rule
            );
          }
        });
        ...
        parser.addListener("startrule", function (event) {
          ...
          for (i = 0; i < selectors.length; i++) {
            ...
            if (idCount === 1) {
              ...
              reporter.report(
                idCount + " IDs in the selector, really?",
                selector.line,
                selector.col,
                rule
              );
              ...
              if (
                ...
                reporter.report(
                  "Element (" +
                    classes[prop][0].part +
                    ") is overqualified, just use " +
                    classes[prop][0].modifier +
                    " without element name.",
                  classes[prop][0].part.line,
                  classes[prop][0].part.col,
                  rule
                );
              }
            }
            ...
            if (!properties[needed]) {
              reporter.report(
                "Missing standard property '" +
                  ...
                  actual +
                  "'.",
                properties[actual][0].name.line,
                properties[actual][0].name.col,
                rule
              );
            } else {
    ...
    CSSLint.addRule({
      ...
      init: function (parser, reporter) {
        ...
        parser.addListener("property", function (event) {
          ...
          while (i < len) {
            if (
              (parts[i].units || parts[i].type === "percentage") &&
              parts[i].value === 0 &&
              parts[i].type !== "time"
            ) {
              reporter.report(
            ...
            if (message.rollup) {
              output.push(
                '<issue severity="' +
                  ...
                  '" evidence="' +
                  escapeSpecialCharacters(message.evidence) +
                  '"/>'
              );
            } else {
              output.push(
          ...
          CSSLint.Util.forEach(messages, function (message) {
            if (message.rollup) {
              ...
              if (message.rule && message.rule.id) {
                rule =
                  'rule="' + escapeSpecialCharacters(message.rule.id) + '" ';
              }
              output.push(
                "<issue " +
                  rule +
