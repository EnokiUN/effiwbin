...
define("ace/mode/javascript/jshint", [], function (require, exports, module) {
  module.exports = (function outer(modules, cache, entry) {
  ...
  })(
    {
      ...
      "/../../../jshint/node_modules/underscore/underscore-umd.js": [
        function (_dereq_, module, exports) {
          (function (global) {
            (function (global, factory) {
              ...
              var hasStringTagBug =
                  supportsDataView &&
                  hasObjectTag(new DataView(new ArrayBuffer(8))),
              ...
              function isFinite$1(obj) {
                return (
                  !isSymbol(obj) && _isFinite(obj) && !isNaN(parseFloat(obj))
                );
              }
              ...
              _$1.prototype.valueOf = _$1.prototype.toJSON =
                _$1.prototype.value;
          ...
          var JSHINT = (function () {
            ...
            function quit(code, token, a, b) {
              var percentage = Math.floor(
                (token.line / state.lines.length) * 100
              );
              ...
              if (directiveToken.type === "globals") {
                body.forEach(function (item, idx) {
                  ...
                  if (key.charAt(0) === "-") {
                    ...
                    predef[key] =
                      parts.length > 1 && parts[1].trim() === "true";
                  }
                });
            ...
            function expression(context, rbp) {
              ...
              if (
                initial &&
                curr.fud &&
                (!curr.useFud || curr.useFud(context))
              ) {
                ...
                while (rbp < state.tokens.next.lbp && !isEndOfExpr(context)) {
                  ...
                  if (
                    left &&
                    (left.value || (left.first && left.first.value))
                  ) {
                    if (
                      left.value !== "new" ||
                      (left.first &&
            ...
            function checkLeftSideAssign(context, left, assignToken, options) {
              ...
              if (left.id === ".") {
                ...
                if (
                  state.funct["(scope)"].bindingtype(left.value) === "exception"
                ) {
                  warning("W022", left);
                }
              ...
              if (state.tokens.next.id === "{") {
                ...
                if (
                  ...
                  error(
                    "E048",
                    a[0],
                    a[0].id[0].toUpperCase() + a[0].id.slice(1)
                  );
                }
            ...
            reserve("this", function () {
              if (
                ...
                ((state.funct["(statement)"] &&
                  state.funct["(name)"].charAt(0) > "Z") ||
                  state.funct["(global)"])
              ) {
                warning("W040", this);
              }
              ...
              function (context, left, that) {
                ...
                if (left) {
                  if (left.type === "(identifier)") {
                    ...
                    if (
                      newcapRe.test(left.value) &&
                      newcapIgnore.indexOf(left.value) === -1
                    ) {
                      if (left.value === "Math") {
                        warning("W063", left);
              ...
              if (ret.id === ",") {
                ...
                if (!isNecessary) {
                  ...
                  isNecessary =
                    ...
                    (ret.id === "?." &&
                      (preceeding.id === "new" ||
                        state.tokens.next.type === "(template)"));
                }
              }
            ...
            function doFunction(context, options) {
              ...
              var internallyAccessibleName =
                !isMethod && (name || classExprBinding);
            ...
            function destructuringPatternMatch(tokens, value) {
              ...
              _.zip(tokens, Array.isArray(first) ? first : [first]).forEach(
                function (val) {
                  var token = val[0];
                  var value = val[1];
            ...
            function blockVariableStatement(type, statement, context) {
              ...
              for (;;) {
                ...
                if (_.includes(["{", "["], state.tokens.next.value)) {
                  ...
                  tokens = [
                    { id: identifier(context), token: state.tokens.curr },
                  ];
                  lone = true;
                }
            ...
            letstatement.useFud = function (context) {
              ...
              nextIsBindingName =
                next.identifier &&
                (!isReserved(context, next) || next.id === "let");
                  ...
                  if (tokens.hasOwnProperty(t)) {
                    ...
                    if (state.funct["(global)"] && !state.impliedClosure()) {
                      if (predefined[t.id] === false) {
                        ...
                        if (
                          (!state.inES5() &&
                            vars.ecmaIdentifiers[5][t.id] === false) ||
                          (!state.inES6() &&
                            vars.ecmaIdentifiers[6][t.id] === false)
                        ) {
            ...
            blockstmt("function", function (context) {
              ...
              this.name = optionalidentifier(context)
                ? state.tokens.curr
                : null;
            ...
            blockstmt("if", function (context) {
              ...
              if (state.option.forin && state.forinifcheckneeded) {
                ...
                forinifcheck =
                  state.forinifchecks[state.forinifchecks.length - 1];
            ...
            (function (yieldSymbol) {
              ...
              prefix("yield", function (context) {
                ...
                if (!(context & prodParams.yield)) {
                  this.exps = false;
                  return state.syntax["(identifier)"].nud.apply(
                    this,
                    arguments
                  );
                }
            ...
            stmt("export", function (context) {
              ...
              if (state.tokens.next.type === "default") {
                ...
                if (exportType === "function") {
                  ...
                  advance("async");
                  advance("function");
                  token = state.syntax["function"].fud(
                    context | prodParams.preAsync
                  );
                  state.funct["(scope)"].setExported(token.name, def);
            ...
            function saveAccessor(
              ...
              var flagName =
                accessorType === "get" ? "getterToken" : "setterToken";
              var key = name;
              ...
              if (props[key]) {
                if (
                  (props[key].basic || props[key][flagName]) &&
                  name !== "__proto__"
                ) {
                  var msg = "";
                  if (isClass) {
                ...
                if (state.tokens.next.id !== "}") {
                  for (;;) {
                    ...
                    if (o[state.tokens.next.value] === true) {
                      ...
                      (state.tokens.next.value === "__proto__" &&
                        !state.option.proto) ||
            ...
            var itself = function (s, o, g) {
              ...
              var scopeManagerInst = scopeManager(
                state,
                predefined,
                exported,
                declared
              ...
              api = {
                ...
                warn: function (code, data) {
                  warningAt.apply(
                    null,
                    [code, data.line, data.char].concat(data.data)
                  );
                },
              ...
              lex.on("warning", function (ev) {
                warningAt.apply(
                  null,
                  [ev.code, ev.line, ev.character].concat(ev.data)
                );
              });
      ...
      "/../../../jshint/src/lex.js": [
        function (_dereq_, module, exports) {
          ...
          var nonAsciiIdentifierStartTable = _dereq_(
            "../data/non-ascii-identifier-start.js"
          );
          var nonAsciiIdentifierPartTable = _dereq_(
          ...
          Lexer.prototype = {
            ...
            currentContext: function () {
              return (
                this.context.length > 0 && this.context[this.context.length - 1]
              );
            },
              ...
              function commentToken(label, body, opt) {
                ...
                special.forEach(function (str) {
                  ...
                  if (
                    ...
                    var isAllWhitespace =
                      body.substr(0, strIndex).trim().length === 0;
                    if (isAllWhitespace) {
                      isSpecial = true;
            ...
            scanTemplateLiteral: function (checks) {
              ...
              if (this.peek() === "`") {
                ...
                this.inContext(Context.Template) &&
                this.peek() === "}"
              ) {
            ...
            scanRegExp: function (checks) {
              ...
              var scanRegexpEscapeSequence = function () {
                ...
                if (char === "p" || char === "P") {
                  ...
                  if (
                    !sequence ||
                    !_dereq_("./validate-unicode-escape-sequence")(sequence)
                  ) {
                    this.triggerAsync(
                      "error",
                      {
                ...
                if (char === "<") {
                  ...
                  char === "0" &&
                  reg.decimalDigit.test(this.peek(index + 1))
                ) {
                  this.triggerAsync(
                    "error",
                    {
              ...
              while (index < length) {
                ...
                if (char === "y") {
                  ...
                  var hasInvalidEscape = (function (
                    ...
                    var hasInvalidGroup = groupReferences.some(function (
                      groupReference
                    ) {
              ...
              if (malformedDesc) {
                ...
                allFlags.indexOf("s") > -1 &&
                !reg.regexpDot.test(body)
              ) {
                this.trigger("warning", {
                  code: "W148",
                  line: this.line,
            ...
            token: function () {
              ...
              var create = function (type, value, isProperty, token) {
                ...
                if (type === "(punctuator)") {
                  ...
                  obj = Object.create(
                    state.syntax[value] || state.syntax["(error)"]
                  );
                }
                ...
                switch (token.type) {
                  ...
                  case Token.NumericLiteral:
                    ...
                    this.triggerAsync(
                      ...
                      function () {
                        return (
                          state.isStrict() && token.base === 8 && token.isLegacy
                        );
                      }
                    );
        ...
        },
        {
          ...
          "./validate-unicode-escape-sequence":
            "/../../../jshint/src/validate-unicode-escape-sequence.js",
          events: "/node_modules/events/events.js",
          underscore:
            "/../../../jshint/node_modules/underscore/underscore-umd.js",
        },
      ...
      "/../../../jshint/src/messages.js": [
        function (_dereq_, module, exports) {
          ...
          var errors = {
            ...
            E065:
              "Functions defined outside of strict mode with non-simple parameter lists may not " +
              "enable strict mode.",
          ...
          var warnings = {
            ...
            W020: "Read only.",
            W021:
              "Reassignment of '{a}', which is a {b}. " +
            ...
            W143:
              "Assignment to properties of a mapped arguments object may cause " +
          ...
          var scopeManager = function (state, predefined, exported, declared) {
            ...
            function _newScope(type) {
              _current = {
                ...
                "(type)": type,
                "(params)":
                  type === "functionparams" || type === "catchparams"
                    ? []
                    : null,
              };
            ...
            var _warnUnused = function (name, tkn, type, unused_opt) {
              ...
              if (unused_opt) {
                if (
                  ...
                  warnable_types[unused_opt].indexOf(type) !== -1
                ) {
            ...
            function _checkForUnused() {
              if (_current["(type)"] !== "functionparams") {
                ...
                for (var bindingName in currentBindings) {
                  if (
                    currentBindings[bindingName]["(type)"] !== "exception" &&
                    currentBindings[bindingName]["(unused)"]
                  ) {
                    _warnUnused(
                      bindingName,
                      currentBindings[bindingName]["(token)"],
                      "var"
                    );
                  }
                }
            ...
            function _checkOuterShadow(bindingName, token) {
              ...
              for (var i = 0; i < _scopeStack.length; i++) {
                ...
                if (
                  !isNewFunction &&
                  _scopeStack[i + 1] === _currentFunctBody
                ) {
                  outsideCurrentFunction = false;
                }
                if (
                  outsideCurrentFunction &&
                  stackItem["(bindings)"][bindingName]
                ) {
            ...
            function _latedefWarning(type, bindingName, token) {
              ...
              if (state.option.latedef) {
                isFunction =
                  ...
                  type === "async function";
                if (
                  (state.option.latedef === true && isFunction) ||
                  !isFunction
                ) {
            ...
            var scopeManagerInst = {
              ...
              isPredefined: function (bindingName) {
                return (
                  !this.has(bindingName) &&
                  _.has(_scopeStack[0]["(predefined)"], bindingName)
                );
              },
              stack: function (type) {
              ...
              unstack: function () {
                var subScope =
                  _scopeStack.length > 1
                    ? _scopeStack[_scopeStack.length - 2]
                    : null;
                var isUnstackingFunctionBody = _current === _currentFunctBody,
                  isUnstackingFunctionParams =
                    _current["(type)"] === "functionparams",
                  isUnstackingFunctionOuter =
                    _current["(type)"] === "functionouter";
                ...
                if (
                  currentUsages.__proto__ &&
                  usedBindingNameList.indexOf("__proto__") === -1
                ) {
                ...
                for (i = 0; i < usedBindingNameList.length; i++) {
                  ...
                  if (usedBinding) {
                    ...
                    isImmutable =
                      usedBindingType === "const" ||
                      usedBindingType === "import";

                    if (
                      usedBinding["(useOutsideOfScope)"] &&
                      !state.option.funcscope
                    ) {
                      var usedTokens = usage["(tokens)"];
                      for (j = 0; j < usedTokens.length; j++) {
                        if (
                          usedBinding["(function)"] ===
                          usedTokens[j]["(function)"]
                        ) {
                  ...
                  if (subScope) {
                    ...
                    isImmutable =
                      bindingType === "const" ||
                      (bindingType === null &&
                        _scopeStack[0]["(predefined)"][usedBindingName] ===
                          false);
                    ...
                    if (!subScope["(usages)"][usedBindingName]) {
                      ...
                      if (isUnstackingFunctionBody) {
                        subScope["(usages)"][usedBindingName][
                          "(onlyUsedSubFunction)"
                        ] = true;
                      }
                    } else {
                      var subScopeUsage = subScope["(usages)"][usedBindingName];
                      subScopeUsage["(modified)"] = subScopeUsage[
                        "(modified)"
                      ].concat(usage["(modified)"]);
                      subScopeUsage["(tokens)"] = subScopeUsage[
                        "(tokens)"
                      ].concat(usage["(tokens)"]);
                      subScopeUsage["(reassigned)"] = subScopeUsage[
                        "(reassigned)"
                      ].concat(usage["(reassigned)"]);
                    }
                  } else {
                    if (
                      typeof _current["(predefined)"][usedBindingName] ===
                      "boolean"
                    ) {
                      delete declared[usedBindingName];
                      usedPredefinedAndGlobals[usedBindingName] = marker;
                      if (
                        _current["(predefined)"][usedBindingName] === false &&
                        usage["(reassigned)"]
                      ) {
                        for (j = 0; j < usage["(reassigned)"].length; j++) {
                ...
                if (!subScope) {
                  Object.keys(declared).forEach(function (bindingNotUsed) {
                    _warnUnused(
                      bindingNotUsed,
                      declared[bindingNotUsed],
                      "var"
                    );
                  });
                }
                if (
                  ...
                  for (i = 0; i < bindingNames.length; i++) {
                    ...
                    if (
                      !defBinding["(blockscoped)"] &&
                      defBinding["(type)"] !== "exception"
                    ) {
                  ...
                  _currentFunctBody =
                    _scopeStack[
                      _.findLastIndex(_scopeStack, function (scope) {
                        return (
                          scope["(isFuncBody)"] || scope["(type)"] === "global"
                        );
                      })
                    ];
                }
              ...
              addParam: function (bindingName, token, type) {
                ...
                if (type === "exception") {
                  var previouslyDefinedBindingType =
                    this.funct.bindingtype(bindingName);
                  if (
                    previouslyDefinedBindingType &&
                    previouslyDefinedBindingType !== "exception"
                  ) {
                    if (!state.option.node) {
                  ...
                  if (
                    state.isStrict() &&
                    (bindingName === "arguments" || bindingName === "eval")
                  ) {
                    warning("E008", token);
                  }
                }
              ...
              validateParams: function (isArrow) {
                ...
                currentFunctParamScope["(params)"].forEach(function (
                  bindingName
                ) {
                  var binding =
                    currentFunctParamScope["(bindings)"][bindingName];
              ...
              getUsedOrDefinedGlobals: function () {
                ...
                if (
                  usedPredefinedAndGlobals.__proto__ === marker &&
              ...
              addExported: function (bindingName) {
                ...
                if (_.has(declared, bindingName)) {
                  ...
                  for (var i = 1; i < _scopeStack.length; i++) {
                    ...
                    if (!scope["(type)"]) {
                      if (
                        _.has(scope["(bindings)"], bindingName) &&
              ...
              addbinding: function (bindingName, opts) {
                ...
                var ishoisted =
                  ...
                  type === "import";
                var isexported =
                  (isblockscoped ? _current : _currentFunctBody)["(type)"] ===
                    "global" && _.has(exported, bindingName);
                _checkOuterShadow(bindingName, token);
                ...
                if (isblockscoped) {
                  ...
                  if (
                    ...
                    declaredInCurrentScope =
                      !!_currentFunctBody["(parent)"]["(bindings)"][
                        bindingName
                      ];
                  }
                  if (
                  ...
                  var declaredInCurrentFunctionScope =
                    scopeManagerInst.funct.has(bindingName);
                  if (
                    !declaredInCurrentFunctionScope &&
                    usedSoFarInCurrentFunction(bindingName)
                  ) {
                    _latedefWarning(type, bindingName, token);
                  }
                  if (
              ...
              funct: {
                bindingtype: function (bindingName, options) {
                  ...
                  var currentScopeIndex =
                    _scopeStack.length -
                    (options && options.excludeCurrent ? 2 : 1);
                  for (var i = currentScopeIndex; i >= 0; i--) {
                    var current = _scopeStack[i];
                    if (
                      current["(bindings)"][bindingName] &&
                      (!onlyBlockscoped ||
                        current["(bindings)"][bindingName]["(blockscoped)"])
                    ) {
                      return current["(bindings)"][bindingName]["(type)"];
                    }
                    var scopeCheck = excludeParams
                      ? _scopeStack[i - 1]
                      : current;
                    if (
                      scopeCheck &&
                      scopeCheck["(type)"] === "functionparams"
                    ) {
                      return null;
                    }
                  }
              ...
              block: {
                ...
                use: function (bindingName, token) {
                  ...
                  if (
                    paramScope &&
                    paramScope["(bindings)"][bindingName] &&
                  ...
                  if (
                    token &&
                    (state.ignored.W117 || state.option.undef === false)
                  ) {
