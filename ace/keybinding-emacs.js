define("ace/occur", [
  ...
  (function () {
    ...
    this.exit = function (editor, options) {
      ...
      var translatedPos =
        pos && this.occurToOriginalPosition(editor.session, pos);
...
define("ace/commands/occur_commands", [
  "require",
  "exports",
  "module",
  "ace/config",
...
define("ace/incremental_search", [
  ...
  (function () {
    this.activate = function (editor, backwards) {
      ...
      this.$mousedownHandler = editor.on(
        "mousedown",
    ...
    this.highlightAndFindWithNeedle = function (moveToNext, needleUpdateFunc) {
      ...
      if (needleUpdateFunc) {
        options.needle =
          needleUpdateFunc.call(this, options.needle || "") || "";
      }
      ...
      if (found) {
        ...
        this.$editor.selection.setRange(
          Range.fromPoints(shouldSelect ? this.$startPos : found.end, found.end)
        );
    ...
    this.removeChar = function (c) {
      return this.highlightAndFindWithNeedle(false, function (needle) {
        ...
        var reObj = regExpToObject(needle);
        reObj.expression = reObj.expression.substring(
          0,
          reObj.expression.length - 1
        );
        return objectToRegExp(reObj);
      });
    };
...
define("ace/keyboard/emacs", [
  ...
  exports.handler.attach = function (editor) {
    ...
    editor.getLastEmacsMark = function (p) {
      return (
        this.session.$emacsMark || this.session.$emacsMarkRing.slice(-1)[0]
      );
    };
    ...
    killRingSave: {
      exec: function (editor) {
        ...
        setTimeout(function () {
          ...
          editor.setEmacsMark(null);
          editor.session.$emacsMarkRing = marks.concat(
            deselectedMarks.reverse()
          );
        }, 0);
      },
      readOnly: true,
