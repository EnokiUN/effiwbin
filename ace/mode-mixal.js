define("ace/mode/mixal_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var MixalHighlightRules = function () {
    var isValidSymbol = function (string) {
      return (
        string &&
        string.search(/^[A-Z\u0394\u03a0\u03a30-9]{1,10}$/) > -1 &&
        string.search(/[A-Z\u0394\u03a0\u03a3]/) > -1
      );
    };
        ...
        },
        {
          token: function (label, space0, keyword, space1, literal, comment) {
            return [
              ...
              "keyword.control",
              "text",
              containsOnlySupportedCharacters(literal)
                ? "text"
                : "invalid.illegal",
        ...
        },
        {
          token: function (label, space0, op, space1, address, comment) {
            return [
              ...
              isValidOp(op) ? "keyword.control" : "invalid.illegal",
              "text",
              containsOnlySupportedCharacters(address)
                ? "text"
                : "invalid.illegal",
              "comment.line.character",
            ];
...
define("ace/mode/mixal", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  "ace/mode/text",
  "ace/mode/mixal_highlight_rules",
], function (require, exports, module) {
  "use strict";
  var oop = require("../lib/oop");
  var TextMode = require("./text").Mode;
  var MixalHighlightRules =
    require("./mixal_highlight_rules").MixalHighlightRules;
  var Mode = function () {
