...
define("ace/mode/yaml/yaml-lint", [], function (require, exports, module) {
          ...
          function (require, module, exports) {
            ...
            function writeBlockSequence(state, level, object, compact) {
              ...
              for (
                ...
                if (writeNode(state, level + 1, object[index], true, true)) {
                  ...
                  if (
                    state.dump &&
                    CHAR_LINE_FEED === state.dump.charCodeAt(0)
                  ) {
                    _result += "-";
                  } else {
                    _result += "- ";
            ...
            function writeBlockMapping(state, level, object, compact) {
              ...
              for (
                ...
                if (
                  !writeNode(state, level + 1, objectValue, true, explicitPair)
                ) {
                  continue; // Skip this pair because of invalid value.
                }
              ...
              for (
                ...
                if (
                  ...
                  if (type.represent) {
                    ...
                    if (
                      _toString.call(type.represent) === "[object Function]"
                    ) {
        ...
        8: [
          function (require, module, exports) {
              ...
              while (ch !== 0) {
                ...
                if (ch === 0x2b /* + */ || ch === 0x2d /* - */) {
                  if (CHOMPING_CLIP === chomping) {
                    chomping =
                      ch === 0x2b /* + */ ? CHOMPING_KEEP : CHOMPING_STRIP;
                  } else {
              ...
              if (indentStatus === 1 || CONTEXT_BLOCK_OUT === nodeContext) {
                ...
                if (indentStatus === 1) {
                  if (
                    ...
                    if (
                      (allowBlockScalars &&
                        readBlockScalar(state, flowIndent)) ||
            ...
            function loadDocuments(input, options) {
              ...
              while (
                state.input.charCodeAt(state.position) === 0x20 /* Space */
              ) {
                state.lineIndent += 1;
                state.position += 1;
              }
          ...
          function (require, module, exports) {
            ...
            function compileMap(/* lists... */) {
              ...
              function collectType(type) {
                result[type.kind][type.tag] = result["fallback"][type.tag] =
                  type;
              }
