...
define("ace/mode/mysql_highlight_rules", [
  ...
  var MysqlHighlightRules = function () {
    var mySqlKeywords =
      /*sql*/ "alter|and|as|asc|between|count|create|delete|desc|distinct|drop|from|having|in|insert|into|is|join|like|not|on|or|order|select|set|table|union|update|values|where" +
    ...
    var keywordMapper = this.createKeywordMapper(
      {
        ...
        constant:
          "false|true|null|unknown|date|time|timestamp|ODBCdotTable|zerolessFloat",
