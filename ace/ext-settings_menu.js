  ...
  (function () {
    ...
    this.renderOptionControl = function (key, option) {
      ...
      if (option.type == "buttonBar") {
        control = [
          "div",
          { role: "group", "aria-labelledby": option.path + "-label" },
            ...
            return [
              "button",
              {
                ...
                onclick: function () {
                  ...
                  var nodes = this.parentNode.querySelectorAll(
                    "[ace_selected_button]"
                  );
    ...
    this.renderOption = function (key, option) {
      ...
      return [
        ...
        ["td", ["label", { for: safeKey, id: safeId }, key]],
        ["td", control],
      ];
    };
