    ...
    this.$rules = {
      start: [
        ...
        },
        {
          ...
          regex:
            /\b(abs|min|max|within|ripemd160|sha1|sha256|hash160|hash256|checkSig|checkMultiSig|num2bin|pack|unpack|len|reverseBytes|repeat)(\s*)(\()/,
        },
        {
          token: [
          ...
          regex:
            /\b(SigHash)(\s*)(\.)(\s*)(ANYONECANPAY|ALL|FORKID|NONE|SINGLE)\b/,
        },
        {
          token: [
            "entity.name.type.scrypt",
...
*/
  ...
  var scryptHighlightRules =
    require("./scrypt_highlight_rules").scryptHighlightRules;
