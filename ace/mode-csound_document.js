...
define("ace/mode/lua_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
...
define("ace/mode/csound_orchestra_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/lang",
  ...
  var CsoundOrchestraHighlightRules = function (embeddedRulePrefix) {
    ...
    start.push(
      ...
      },
      {
        ...
        onMatch: function (value, currentState, stack, line) {
          ...
          var name = tokens[1];
          var type;
          if (opcodes.hasOwnProperty(name)) type = "support.function.csound";
    ...
    this.embedRules(
      scoreHighlightRules.getRules(),
      scoreHighlightRules.embeddedRulePrefix,
      rules
    );
...
define("ace/mode/csound_document_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  "use strict";
  var oop = require("../lib/oop");
  var CsoundOrchestraHighlightRules =
  ...
  var CsoundDocumentHighlightRules = function () {
    ...
    this.embedRules(
      orchestraHighlightRules.getRules(),
      orchestraHighlightRules.embeddedRulePrefix,
      [
        {
          token: [
            "meta.tag.punctuation.end-tag-open.csound-document",
...
define("ace/mode/csound_document", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var CsoundDocumentHighlightRules =
    require("./csound_document_highlight_rules").CsoundDocumentHighlightRules;
  var Mode = function () {
