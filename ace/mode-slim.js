define("ace/mode/slim_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/config",
    ...
    var codeBlockRules = [
      {
        ...
        onMatch: function (value, state, stack, line) {
          ...
          if (
            m &&
            m[1].length < indent.length + 3 &&
            m[2].length >= endMarker.length &&
            m[2][0] == endMarker[0]
          ) {
            stack.splice(0, 3);
            this.next = stack.shift();
          ...
          if (language && modes[language]) {
            var data = modes[language]
              .getTokenizer()
              .getLineTokens(value, embedState.slice(0));
            stack[1] = data.state;
            return data.tokens;
          }
          return this.token;
  ...
  (function () {
    ...
    this.getFoldWidgetRange = function (session, foldStyle, row) {
      ...
      if (isHeading(row)) {
        ...
        endRow =
          row - (!token || ["=", "-"].indexOf(token.value[0]) == -1 ? 1 : 2);
        if (endRow > startRow) {
...
define("ace/mode/coffee_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
      ...
      start: [
        ...
        },
        {
          token: function (value) {
            ...
            else if (functions.hasOwnProperty(value)) return "support.function";
...
define("ace/mode/less_highlight_rules", [
  ...
  var LessHighlightRules = function () {
    var keywordList =
      "@import|@media|@font-face|@keyframes|@-webkit-keyframes|@supports|" +
...
define("ace/mode/ruby_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  (function () {
    ...
    this.getFoldWidget = function (session, foldStyle, row) {
      ...
      if (match[3] === "end") {
        ...
        if (
          session.getTokenAt(row, match.index + 1).type === "comment.multiline"
        )
          return "end";
      } else return "end";
    };
