...
define("ace/mode/livescript", [
  ...
  exports.Mode = LiveScriptMode = (function (superclass) {
    var indenter,
      prototype = extend$(
        ((import$(LiveScriptMode, superclass).displayName = "LiveScriptMode"),
        LiveScriptMode),
        superclass
      ).prototype,
    ...
    function LiveScriptMode() {
      var that;
      this.$tokenizer = new (require("../tokenizer").Tokenizer)(
    ...
    prototype.checkOutdent = function (state, line, input) {
      var ref$;
      return (ref$ = this.$outdent) != null
        ? ref$.checkOutdent(line, input)
        : void 8;
    };
    prototype.autoOutdent = function (state, doc, row) {
      var ref$;
      return (ref$ = this.$outdent) != null
        ? ref$.autoOutdent(doc, row)
        : void 8;
    };
