define("ace/mode/apache_conf_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
    ...
    this.$rules = {
      start: [
        ...
        },
        {
          ...
          regex:
            "(ScriptAliasMatch|AliasMatch)(\\s+)(.+?)(\\s+)(?:(.+?)(\\s))?",
        },
        {
          token: [
            "keyword.alias.apacheconf",
        ...
        },
        {
          ...
          regex:
            "\\b(?:ScriptLog|ScriptLogBuffer|ScriptLogLength|ScriptSock)\\b",
        },
        {
        ...
        },
        {
          ...
          regex:
            "\\b(?:BrowserMatch|BrowserMatchNoCase|SetEnvIf|SetEnvIfNoCase)\\b",
        },
        {
...
*/
  ...
  var ApacheConfHighlightRules =
    require("./apache_conf_highlight_rules").ApacheConfHighlightRules;
