define("ace/mode/fortran_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var FortranHighlightRules = function () {
    ...
    var keywordOperators =
      "and|or|not|eq|ne|gt|ge|lt|le|" + "AND|OR|NOT|EQ|NE|GT|GE|LT|LE";
...
define("ace/mode/fortran", [
  ...
  var FortranHighlightRules =
    require("./fortran_highlight_rules").FortranHighlightRules;
