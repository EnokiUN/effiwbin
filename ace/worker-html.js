  ...
  })(
    {
        ...
        function (_dereq_, module, exports) {
          ...
          function isTableBodyScopeMarker(node) {
            return (
              ...
              (node.namespaceURI === "http://www.w3.org/1999/xhtml" &&
                node.localName === "tfoot") ||
              (node.namespaceURI === "http://www.w3.org/1999/xhtml" &&
                node.localName === "thead") ||
              (node.namespaceURI === "http://www.w3.org/1999/xhtml" &&
                node.localName === "html")
            );
          }
          ...
          ElementStack.prototype.furthestBlockForFormattingElement = function (
            element
          ) {
          ...
          ElementStack.prototype.remove_openElements_until = function (
            callback
          ) {
            var finished = false;
            var element;
          ...
          EntityParser.consumeEntity = function (
            ...
            if ((ch >= "a" && ch <= "z") || (ch >= "A" && ch <= "Z")) {
              ...
              if (
                ch === ";" ||
                !additionalAllowedCharacter ||
                !(isAlphaNumeric(ch) || ch === "=")
              ) {
                if (consumedCharacters.length > mostRecentMatch.length) {
                  buffer.unget(
                    consumedCharacters.substring(mostRecentMatch.length)
                  );
                }
                if (ch !== ";") {
          ...
          InputStream.prototype = {
            ...
            matchUntil: function (re) {
              ...
              if (s === InputStream.EOF) {
                ...
                (m = new RegExp(re + (this.eof ? "|$" : "")).exec(s))
              ) {
            ...
            peek: function (n) {
              ...
              if (this.eof && this.start >= this.data.length)
                return InputStream.EOF;
              return this.data
                .slice(this.start, Math.min(this.start + n, this.data.length))
                .toString();
            },
            length: function () {
            ...
            location: function () {
              ...
              var column = newlines
                ? read.length - read.lastIndexOf("\n") - 1
                : lastColumn + read.length;
      ...
      4: [
        function (_dereq_, module, exports) {
          ...
          StackItem.prototype.isSpecial = function () {
            return (
              this.namespaceURI in SpecialElements &&
        ...
        function (_dereq_, module, exports) {
          ...
          Tokenizer.prototype.tokenize = function (source) {
            ...
            function character_reference_in_attribute_value_state(buffer) {
              var character = EntityParser.consumeEntity(
                buffer,
                tokenizer,
                this._additionalAllowedCharacter
              );
            ...
            function markup_declaration_open_state(buffer) {
              ...
              if (chars === "--") {
                ...
                if (chars.toUpperCase() === "DOCTYPE") {
                  ...
                  tokenizer._tokenHandler.isCdataSectionAllowed() &&
                  chars === "[CDATA["
                ) {
            ...
            function between_doctype_public_and_system_identifiers_state(
              buffer
            ) {
              var data = buffer.char();
              if (data === InputStream.EOF) {
      ...
      6: [
        function (_dereq_, module, exports) {
          ...
          function TreeBuilder() {
            ...
            modes.base = {
              ...
              processStartTag: function (name, attributes, selfClosing) {
                if (this[this.start_tag_handlers[name]]) {
                  this[this.start_tag_handlers[name]](
                    name,
                    attributes,
                    selfClosing
                  );
                } else if (this[this.start_tag_handlers["-default"]]) {
                  this[this.start_tag_handlers["-default"]](
                    name,
                    attributes,
                    selfClosing
                  );
            ...
            modes.initial.processStartTag = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.beforeHTML.startTagHtml = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.beforeHTML.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterAfterBody.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterBody.processStartTag = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.beforeHead.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inHead.startTagBaseBasefontBgsoundLink = function (
              name,
              attributes
            ) {
            ...
            modes.inHead.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inHead.endTagHead = function (name) {
              if (
                tree.openElements.item(tree.openElements.length - 1)
                  .localName == "head"
              ) {
            ...
            modes.afterHead.startTagFromHead = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterHead.startTagHead = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterHead.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inBody.startTagHtml = function (name, attributes) {
              ...
              tree.addAttributesToElement(
                tree.openElements.rootNode,
                attributes
              );
            };
            ...
            modes.inBody.startTagAppletMarqueeObject = function (
              name,
              attributes
            ) {
              tree.reconstructActiveFormattingElements();
            ...
            modes.inBody.startTagParamSourceTrack = function (
              name,
              attributes
            ) {
              tree.insertSelfClosingElement(name, attributes);
            ...
            modes.inBody.startTagMath = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inBody.startTagSVG = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inCaption.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inCell.startTagTableOther = function (
              name,
              attributes,
              selfClosing
            ) {
              if (
                tree.openElements.inTableScope("td") ||
                tree.openElements.inTableScope("th")
              ) {
                this.closeCell();
                tree.insertionMode.processStartTag(
                  name,
                  attributes,
                  selfClosing
                );
            ...
            modes.inCell.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inColumnGroup.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inForeignContent.processStartTag = function (
              name,
              attributes,
              selfClosing
            ) {
              if (
                ...
                (name == "font" &&
                  attributes.some(function (attr) {
                    return (
                      ["color", "face", "size"].indexOf(attr.nodeName) >= 0
                    );
                  }))
              ) {
                ...
                while (
                  tree.currentStackItem().isForeign() &&
              ...
              if (
                tree.currentStackItem().namespaceURI ==
                "http://www.w3.org/1998/Math/MathML"
              ) {
                attributes = tree.adjustMathMLAttributes(attributes);
              }
            ...
            modes.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle =
              function (name, attributes) {
                modes.inHead.processStartTag(name, attributes);
              };

            modes.inHeadNoscript.startTagHeadNoscript = function (
              name,
              attributes
            ) {
            ...
            modes.inFrameset.endTagFrameset = function (name, attributes) {
              ...
              if (
                !tree.context &&
                tree.currentStackItem().localName != "frameset"
              ) {
            ...
            modes.inTable.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inTableText.processStartTag = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inTableBody.startTagTableOther = function (name, attributes) {
              if (
                tree.openElements.inTableScope("tbody") ||
                tree.openElements.inTableScope("thead") ||
                tree.openElements.inTableScope("tfoot")
              ) {
                tree.openElements.popUntilTableBodyScopeMarker();
            ...
            modes.inSelect.endTagOptgroup = function (name) {
              if (
                tree.currentStackItem().localName == "option" &&
                tree.openElements.item(tree.openElements.length - 2)
                  .localName == "optgroup"
              ) {
                tree.popElement();
              }
            ...
            modes.inSelectInTable.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.inRow.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterAfterFrameset.startTagNoFrames = function (
              name,
              attributes
            ) {
              modes.inHead.processStartTag(name, attributes);
            ...
            modes.afterAfterFrameset.startTagOther = function (
              name,
              attributes,
              selfClosing
            ) {
            ...
            modes.afterAfterFrameset.processEndTag = function (
              name,
              attributes
            ) {
            ...
            modes.text.startTagOther = function (name) {
              throw (
                "Tried to process start tag " + name + " in RCDATA/RAWTEXT mode"
              );
            };
            ...
            while (outerLoopCounter++ < outerIterationLimit) {
              ...
              if (
                ...
                (this.openElements.contains(formattingElement) &&
                  !this.openElements.inScope(formattingElement.localName))
              ) {
              ...
              if (!this.openElements.contains(formattingElement)) {
                ...
                this.removeElementFromActiveFormattingElements(
                  formattingElement
                );
                return true;
              }
              ...
              var furthestBlock =
                this.openElements.furthestBlockForFormattingElement(
                  formattingElement.node
                );

              if (!furthestBlock) {
                this.openElements.remove_openElements_until(
                  isActiveFormattingElement
                );
                this.removeElementFromActiveFormattingElements(
                  formattingElement
                );
              ...
              var afeIndex =
                this.openElements.elements.indexOf(formattingElement);
              var commonAncestor = this.openElements.item(afeIndex - 1);

              var bookmark =
                this.activeFormattingElements.indexOf(formattingElement);
              ...
              while (innerLoopCounter++ < innerIterationLimit) {
                ...
                var clone = this.createElement(
                  node.namespaceURI,
                  node.localName,
                  node.attributes
                );
                var newNode = new StackItem(
                  node.namespaceURI,
                  node.localName,
                  node.attributes,
                  clone
                ...
                this.activeFormattingElements[
                  this.activeFormattingElements.indexOf(node)
                ] = newNode;
                this.openElements.elements[
                  this.openElements.elements.indexOf(node)
                ] = newNode;
              ...
              var formattingClone = new StackItem(
              ...
              this.activeFormattingElements.splice(
                Math.min(bookmark, this.activeFormattingElements.length),
                0,
                formattingClone
              );
              ...
              this.openElements.elements.splice(
                this.openElements.elements.indexOf(furthestBlock) + 1,
                0,
                formattingClone
              );
            }
          ...
          TreeBuilder.prototype.createElement = function (
            namespaceURI,
            localName,
            attributes
          ) {
          ...
          TreeBuilder.prototype.attachNodeToFosterParent = function (
            child,
            table,
            stackParent
          ) {
          ...
          TreeBuilder.prototype.addAttributesToElement = function (
            element,
            attributes
          ) {
            throw new Error("Not implemented");
          ...
          TreeBuilder.prototype.insertIntoFosterParent = function (node) {
            ...
            this.attachNodeToFosterParent(
              node,
              tableElement,
              this.openElements.item(tableIndex - 1).node
            );
          };

          TreeBuilder.prototype.insertElement = function (
            name,
            attributes,
            namespaceURI,
            selfClosing
            ...
            if (this.shouldFosterParent()) this.insertIntoFosterParent(element);
            else this.attachNode(element, this.openElements.top.node);
            if (!selfClosing)
              this.openElements.push(
                new StackItem(namespaceURI, name, attributes, element)
              );
          };

          TreeBuilder.prototype.insertFormattingElement = function (
            name,
            attributes
          ) {
            this.insertElement(
          ...
          TreeBuilder.prototype.insertSelfClosingElement = function (
            name,
            attributes
          ) {
          ...
          TreeBuilder.prototype.insertForeignElement = function (
            name,
            attributes,
            namespaceURI,
            selfClosing
          ...
          TreeBuilder.prototype.insertDoctype = function (
            name,
            publicId,
            systemId
          ) {
          ...
          TreeBuilder.prototype.generateImpliedEndTags = function (exclude) {
            ...
            if (
              ["dd", "dt", "li", "option", "optgroup", "p", "rp", "rt"].indexOf(
                name
              ) != -1 &&
              name != exclude
            ) {
          ...
          TreeBuilder.prototype.reconstructActiveFormattingElements =
            function () {
          ...
          TreeBuilder.prototype.ensureNoahsArkCondition = function (item) {
            ...
            for (
              ...
              if (
                item.localName !== candidate.localName ||
                item.namespaceURI !== candidate.namespaceURI
              )
                continue;
            ...
            for (var i = 0; i < attributes.length; i++) {
              ...
              for (var j = 0; j < candidates.length; j++) {
                ...
                var candidateAttribute = getAttribute(
                  candidate,
                  attribute.nodeName
                );
                if (
                  candidateAttribute &&
                  candidateAttribute.nodeValue === attribute.nodeValue
                )
          ...
          TreeBuilder.prototype.appendElementToActiveFormattingElements =
            function (item) {
              this.ensureNoahsArkCondition(item);
              this.activeFormattingElements.push(item);
            };
          TreeBuilder.prototype.removeElementFromActiveFormattingElements =
            function (item) {
              var index = this.activeFormattingElements.indexOf(item);
              if (index >= 0) this.activeFormattingElements.splice(index, 1);
            };

          TreeBuilder.prototype.elementInActiveFormattingElements = function (
            name
          ) {
          ...
          TreeBuilder.prototype.clearActiveFormattingElements = function () {
            while (
              !(
                ...
                this.activeFormattingElements.pop() == Marker
              )
            );
          };

          TreeBuilder.prototype.reparentChildren = function (
            oldParent,
            newParent
          ) {
            throw new Error("Not implemented");
            ...
            for (var i = this.openElements.length - 1; i >= 0; i--) {
              ...
              if (node.namespaceURI === "http://www.w3.org/1999/xhtml") {
                ...
                if (node.localName === "html")
                  ...
                  else return this.setInsertionMode("afterHead");
              }
          ...
          TreeBuilder.prototype.processGenericRCDATAStartTag = function (
            name,
            attributes
          ) {
          ...
          TreeBuilder.prototype.processGenericRawTextStartTag = function (
            name,
            attributes
          ) {
            this.insertElement(name, attributes);
          ...
          TreeBuilder.prototype.adjustForeignAttributes = function (
            attributes
          ) {
            for (var i = 0; i < attributes.length; i++) {
              var attribute = attributes[i];
      ...
      10: [
        function (_dereq_, module, exports) {
          ...
          SAXTreeBuilder.prototype.insertDoctype = function (
            name,
            publicId,
            systemId
          ) {
          ...
          SAXTreeBuilder.prototype.createElement = function (
            namespaceURI,
            localName,
            attributes
          ) {
          ...
          SAXTreeBuilder.prototype.attachNodeToFosterParent = function (
            child,
            table,
            stackParent
          ) {
            ...
            else stackParent.appendChild(child);
          };
          ...
          SAXTreeBuilder.prototype.reparentChildren = function (
            oldParent,
            newParent
          ) {
          ...
          SAXTreeBuilder.prototype.addAttributesToElement = function (
            element,
            attributes
          ) {
            for (var i = 0; i < attributes.length; i++) {
          ...
          IgnorableWhitespace.prototype.visit = function (treeParser) {
            treeParser.ignorableWhitespace(
              this.data,
              0,
              this.data.length,
              this
      ...
      11: [
        function (_dereq_, module, exports) {
          ...
          TreeParser.prototype.characters = function (
            ch,
            start,
            length,
            locator
          ...
          TreeParser.prototype.endElement = function (
            uri,
            localName,
            qName,
            locator
          ...
          TreeParser.prototype.ignorableWhitespace = function (
            ch,
            start,
            length,
            locator
          ...
          TreeParser.prototype.processingInstruction = function (
            target,
            data,
            locator
          ) {
          ...
          TreeParser.prototype.startElement = function (
            uri,
            localName,
            qName,
            atts,
          ...
          TreeParser.prototype.startPrefixMapping = function (
            prefix,
            uri,
            locator
          ) {
          ...
          TreeParser.prototype.startDTD = function (
            name,
            publicId,
            systemId,
            locator
          ...
          Object.defineProperty(TreeParser.prototype, "columnNumber", {
            get: function () {
              if (!this.locatorDelegate) return -1;
              else return this.locatorDelegate.columnNumber;
            },
          });
          ...
          Object.defineProperty(TreeParser.prototype, "lineNumber", {
            get: function () {
              if (!this.locatorDelegate) return -1;
              else return this.locatorDelegate.lineNumber;
            },
          });
