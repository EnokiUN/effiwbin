define("ace/mode/nim_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var NimHighlightRules = function () {
    ...
    var floatNumberExt =
      ...
      ")(?:'(?:(?:[fF](?:32|64)?)|[dD]))";
    var stringEscape =
      "\\\\([abeprcnlftv\\\"']|x[0-9A-Fa-f]{2}|[0-2][0-9]{2}|u[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})";
    ...
    this.$rules = {
      start: [
        ...
        },
        {
          token: "string",
          regex:
            "'(?:\\\\(?:[abercnlftv]|x[0-9A-Fa-f]{2}|[0-2][0-9]{2}|u[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})|.{1})?'",
        },
        {
          include: "methods",
        },
