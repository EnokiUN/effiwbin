...
define("ace/mode/elixir_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
    ...
    this.$rules = {
      start: [
        ...
        },
        {
          ...
          push: [
            { token: "comment.documentation.string", regex: '"', next: "pop" },
            { include: "#interpolated_elixir" },
            { include: "#escaped_char" },
        ...
        { token: "keyword.operator.arithmetic.elixir", regex: "\\*|\\+|\\-|/" },
        {
...
define("ace/mode/html_elixir_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
...
define("ace/mode/html_elixir", [
  ...
  "use strict";
  var oop = require("../lib/oop");
  var HtmlElixirHighlightRules =
    require("./html_elixir_highlight_rules").HtmlElixirHighlightRules;
