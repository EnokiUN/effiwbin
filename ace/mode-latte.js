...
define("ace/mode/latte_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var LatteHighlightRules = function () {
    ...
    this.$rules["latte-content"] = [
      ...
      },
      {
        ...
        regex:
          "\\b(?:INF|NAN|and|or|xor|AND|OR|XOR|clone|new|instanceof|return|continue|break|as)\\b",
      },
      {
        token: "constant.language",
...
define("ace/mode/latte", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  "ace/mode/html",
  "ace/mode/latte_highlight_rules",
  "ace/mode/matching_brace_outdent",
], function (require, exports, module) {
  "use strict";
  var oop = require("../lib/oop");
  var HtmlMode = require("./html").Mode;
  var LatteHighlightRules =
    require("./latte_highlight_rules").LatteHighlightRules;
  var MatchingBraceOutdent =
    require("./matching_brace_outdent").MatchingBraceOutdent;
  var Mode = function () {
    HtmlMode.call(this);
