define("ace/mode/logtalk_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
    ...
    this.$rules = {
      start: [
        ...
        },
        {
          ...
          regex:
            ":-\\s(?:e(?:lse|ndif)|built_in|dynamic|synchronized|threaded)(?=[.])",
        },
        {
          caseInsensitive: false,
          todo: "fix grouping",
        ...
        { token: "keyword.operator.external-call.logtalk", regex: "([{}])" },
        ...
        },
        {
          ...
          regex:
            "\\b(a(bs|cos|sin|tan|tan2)|c(eiling|os)|div|exp|flo(at(_(integer|fractional)_part)?|or)|log|m(ax|in|od)|r(em|ound)|s(i(n|gn)|qrt)|t(an|runcate)|xor)(?=[(])",
        },
        {
          token: "support.function.control.logtalk",
          regex:
            "\\b(?:true|fa(?:il|lse)|repeat|(?:instantiation|system)_error)\\b(?![-!(^~])",
        },
        {
          token: "support.function.control.logtalk",
          regex:
            "\\b((?:type|domain|existence|permission|representation|evaluation|resource|syntax)_error)(?=[(])",
        },
        {
          token: "support.function.control.logtalk",
        ...
        },
        {
          ...
          regex:
            "\\b(logtalk_(?:compile|l(?:ibrary_path|oad|oad_context)|make(_target_action)?))(?=[(])",
        },
        {
          token: "support.function.compiling-and-loading.logtalk",
        ...
        },
        {
          ...
          regex:
            "\\b(threaded_engine(_(create|destroy|self|next(?:_reified)?|yield|post|fetch))?)(?=[(])",
        },
        {
          caseInsensitive: false,
          token: "support.function.reflection.logtalk",
...
define("ace/mode/logtalk", [
  ...
  "ace/mode/text",
  "ace/tokenizer",
  "ace/mode/logtalk_highlight_rules",
...
*/
  ...
  var LogtalkHighlightRules =
    require("./logtalk_highlight_rules").LogtalkHighlightRules;
