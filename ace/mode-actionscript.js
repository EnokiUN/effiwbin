define("ace/mode/actionscript_highlight_rules", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  ...
  var ActionScriptHighlightRules = function () {
    this.$rules = {
      start: [
        ...
        { token: "keyword.operator.actionscript.2", regex: "\\binstanceof\\b" },
        {
...
*/
  ...
  var ActionScriptHighlightRules =
    require("./actionscript_highlight_rules").ActionScriptHighlightRules;
